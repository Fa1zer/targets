...
class PostTableViewCell: UITableViewCell {
    ...
    private func setupViews() {
        ...
        let constraints = [autorLabel.topAnchor.constraint(equalTo: contentView.topAnchor,
                                                           constant: 16),
                          ...
                          likeLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor,
                                                             constant: 16),
                          ...
                          contentView.bottomAnchor.constraint(equalTo: likeLabel.bottomAnchor,
                                                              constant: 16)]
